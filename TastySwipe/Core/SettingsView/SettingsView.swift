                ...
                VStack {
                    ...
                    HStack {
                        ...
                        if Auth.auth().currentUser?.uid != nil {
                            ...
                            .alert("You have successfully logged out!", isPresented: $customAlert, actions: {
                                Button {
                                ...
                                Text("We will miss you, Please come back as soon as possible")
                            })
                            .padding(.bottom, 100)
                        } else {
                ...
                if let newValue = newValue {
                    Task {
                        ...
                        if let downloadURL = downloadURL {
                            ...
                            sessionManager.currentUser?.avatar = downloadURL
